...
class AdmissionConfig:
    ...
    """
    min_trades: int = 30
    min_sharpe: float = 2.0  # FIX (2026-08-27) : seuil strict pour run réel
    min_win_rate: float = 0.65  # FIX (2026-08-27) : seuil strict pour run réel
    min_profit_factor: float = 1.5  # FIX (2026-08-27) : 1.5 au lieu de 1.0
